...
function AppContent() {
  ...
  return (
    <Router>
      <div
        className={`min-h-screen dark:bg-gray-900 dark:text-white bg-gray-100 text-gray-900 py-6 flex flex-col sm:py-12`}
      >
          ...
          <div className='max-w-7xl mx-auto'>
            ...
            {user ? (
              <Routes>
                ...
                <Route
                  path='/tote/:id'
                  element={<ToteDetails totes={totes} onDelete={deleteTote} />}
                />
              </Routes>
            ) : (
              <div className='text-center'>
                <h2 className='text-2xl font-bold mb-4'>
                  Welcome to Binventory
                </h2>
